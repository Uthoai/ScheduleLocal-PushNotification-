 ...
 * Use the [PushNotificationFragment.newInstance] factory method to
...
class PushNotificationFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment PushNotificationFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PushNotificationFragment().apply {
